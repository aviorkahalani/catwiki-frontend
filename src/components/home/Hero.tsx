...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col items-start rounded bg-hero bg-cover bg-center p-10 py-20 shadow">
      ...
      <form
        ...
        className="flex items-center rounded border border-gray-900 p-2.5"
      >
        <input
          type="text"
